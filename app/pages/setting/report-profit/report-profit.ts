...
export class ReportProfitPage {
  ...
  quaterList: any = [
    {date: "2016年1季度", sum: 180000, percent: "69.29%"},
    {date: "2016年2季度", sum: 1660, percent: "0.57%"},
    {date: "2016年3季度", sum: 112000, percent: "10.39%"},
    {date: "2016年4季度", sum: 18000, percent: "6.93%"}
  ];
  ...
  constructor(private navCtrl: NavController) {
    ...
    for(var i=0;i<this.quaterList.length;i++)
    {
      this.totalQuater += this.quaterList[i].sum;
    }
  }
